...
public:
    fbdev_video(int fb_fd, void *fb_ptr, size_t fb_size, struct fb_var_screeninfo vinfo, struct fb_fix_screeninfo finfo, int mmap_flags = 0);
    ...
    int get_font_size() const override { return 9; }
